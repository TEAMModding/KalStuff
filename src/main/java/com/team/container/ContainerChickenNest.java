...
public class ContainerChickenNest extends Container {
	...
	public ContainerChickenNest(InventoryPlayer invPlayer, TileEntityChickenNest tileEntityChickenNest) {
    ...
    final int SLOT_Y_SPACING = 18;
		...
		if (TE_INVENTORY_SLOT_COUNT != tileEntityChickenNest.getSizeInventory()) {
			System.err.println("Mismatched slot count in ContainerChickenNest(" + TE_INVENTORY_SLOT_COUNT
												  + ") and TileInventory (" + tileEntityChickenNest.getSizeInventory()+")");
		}
		final int TILE_INVENTORY_XPOS = 80;
		final int TILE_INVENTORY_YPOS = 20;
		// Add the tile inventory container to the gui
		addSlotToContainer(new Slot(tileEntityChickenNest, 0, TILE_INVENTORY_XPOS, TILE_INVENTORY_YPOS));
	}
	...
	public void onContainerClosed(EntityPlayer playerIn)
	{
		...
		this.tileEntityChickenNest.closeInventory(playerIn);
	}
}
