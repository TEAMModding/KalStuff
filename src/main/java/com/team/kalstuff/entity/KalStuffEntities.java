...
public class KalStuffEntities
{
			...
			int updateFrequency, boolean sendsVelocityUpdates)
	{
		...
		EntityRegistry.registerModEntity(registryName, entityClass, registryName.toString(), entityID++,
				KalStuff.instance, trackingRange, updateFrequency, sendsVelocityUpdates);
	}
			...
			int updateFrequency, boolean sendsVelocityUpdates, int eggPrimary, int eggSecondary)
	{
		final ResourceLocation registryName = new ResourceLocation(KalStuff.MODID, entityName);
		EntityRegistry.registerModEntity(registryName, entityClass, registryName.toString(), entityID++,
				KalStuff.instance, trackingRange, updateFrequency, sendsVelocityUpdates, eggPrimary, eggSecondary);
	}
}
