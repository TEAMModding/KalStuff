...
public class ItemLute extends ItemKalStuff
{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand hand)
	{
		...
		worldIn.playSound(playerIn.posX, playerIn.posY, playerIn.posZ, SoundEvents.BLOCK_NOTE_HARP,
				SoundCategory.AMBIENT, 1.0f, 1.0f, false);
		worldIn.spawnParticle(EnumParticleTypes.NOTE, playerIn.posX, playerIn.posY + 2.5f, playerIn.posZ, 24.0D, 0.0D,
				0.0D, new int[0]);
